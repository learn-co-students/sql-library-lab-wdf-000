...
def select_value_and_count_of_most_prolific_species
  "SELECT characters.species, COUNT(characters.species) AS species_count FROM characters GROUP BY species ORDER BY species_count DESC LIMIT 1;"
end
...
"SELECT series.title FROM series WHERE (SELECT COUNT(characters.species) FROM characters GROUP BY species ORDER BY characters.species) LIMIT 1;"
end
